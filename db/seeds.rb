...
wine_1 = Wine.create!(name: "Domaine du Bienheureux", appellation: "Chateauneuf-du-pape", year: "2020", description: "Parfait pour un repas ! Un vin à contre-pied des standards de Châteauneuf-du-Pape – de la densité et des épices oui mais en finesse ! Tout aussi profond, il a des parfums délicats, avec une touche acidulée voire mentholée en finale… " ,rating: 3.8)#rouge
wine_1 = Wine.create!(name: "Paul Jaboulet Ainé, les Jalets ", appellation: "Rhône Crozes-Hermitage", year: "2021", description: "Un superbe vin blanc, soyeux en bouche et proposant une jolie finale, a consommer autour des 16°C, particulièrement apprécié avec un poisson" ,rating: 3.7)#blanc
...
wine_1 = Wine.create!(name: "Château Minuty, M de Minuty", appellation: "Provence , Côtes de Provence", year: "2022", description: "Sans doute l'un des plus beaux rosé de Provence, un robe claire légèrement saumonnée, un parfun de vivacité et de fraicheur une fois en bouche, le tout dans une bouteille éléguantes reproduisant les courbes du domaine, à consommer !", rating: 4.2)#rosé
wine_1 = Wine.create!(name: "Château du Seuil", appellation: "Provence , Côtes de Provence", year: "2022", description: "Une jolie découverte vous fait envie ? Besoin de voyager à petit prix mais dans un bon confort? Voici ce qu'est ce rosé très bien travaillé, vous emmenant a destination de la provence sans vous bousculer", rating: 3.5)#rosé
wine_1 = Wine.create!(name: "Domaine Casanova", appellation: "Corse", year: "2021", description: "Un vin rosé de Corse fruité et agréable en bouche, à boire bien frais bien sûr. On l'apprécie à l'apéro mais aussi tout le long du repas." ,rating: 3.9)#rosé
wine_1 = Wine.create!(name: "Louis Jadot Bourgogne Couvent des Jacobins", appellation: "Bordeaux Saint-Emillion Grand Cru Classé", year: "2019", description: "Des arômes de petits fruits rouges des bois, avec une finale subtilement fumée ! Idéal pour entrer dans l'univers Jadot !" ,rating: 3.98)#rouge
wine_1 = Wine.create!(name: "Vincent Gaudry Vincengetorix", appellation: "Loire , Sancerre", year: "2020", description: "Le nez développe d’intenses arômes floraux comme la violette et de fruits rouges acidulés. La bouche dévoile de beaux tanins serrés avec une très belle densité. Ce pinot noir se termine en finale avec de belles notes de fruits noirs sauvages. Servir à une température de 12 - 14°" ,rating: 3.52 )#rouge
wine_1 = Wine.create!(name: "Domaine des Cassagnoles Gros Manseng Sélection", appellation: "Sud-Ouest , Côtes de Gascogne", year: "2020", description: "3* coup de coeur du Guide Hachette 2023 !  " ,rating: 4.25)#blanc
wine_1 = Wine.create!(name: "Domaine de Bonnefil, Methode Brut Blanc", appellation: "Sud-Ouest , Gaillac", year: "2019", description: "Saviez-vous que Gaillac avait sa propre spécialité ? Un vin blanc perlant ! Non ce n'est pas un champagne, ni un crémant, ni même un mousseux. Il s'agit là du plus beau vin effervfescent du sud-ouest ! parfait en apéritif ou en dessert" ,rating:3.42)#blanc
wine_1 = Wine.create!(name: "Domaine de L'Estagnère Rosé 2021", appellation: "Languedoc-Roussillon , Cité-de-Carcassonne", year: "2021", description: "Un rosé assez structuré dont la finale en bouche offre une belle persistance. Idéal pour accompagner des viandes grillées au barbecue, il s'ouvrira également sur des arômes plus pâtissiers après 1 an ou 2 en bouteille." ,rating: 3.77)#rosé
wine_1 = Wine.create!(name: "Domaine de L'Ostal Grand Vin 2018", appellation: "Languedoc-Roussillon , Minervois La Livinière", year: "2018", description: "Coup de Coeur 2* du Guide Hachette des vins 2023 !" ,rating: 3.8)#rouge
wine_1 = Wine.create!(name: "Pétrus", appellation: "Bordeaux, Pomerol", year: "1995", description: "Il y a le nom. Il y a le paradis. Il a dieu et son associé. Ils font du vin. Naturellement se noue une complicité entre les hommes, pardon, les dieux, c’est bien normal ; le résultat est…à la hauteur. Vous l’aurez compris, on ne parle ici plus guère de vin tant le liquide est estimé, estimable, choyé, recherché, évocateur, enchanteur…" ,rating: 4.99)#rouge
