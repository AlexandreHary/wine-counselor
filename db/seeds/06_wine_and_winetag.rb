...
WineTag.create!(tag: Tag.find_by(value: "naturel"), wine: wine_1 )

WineTag.create!(tag: Tag.find_by(value: "amis"), wine: wine_2 )
WineTag.create!(tag: Tag.find_by(value: "poisson"), wine: wine_2 )
...
WineTag.create!(tag: Tag.find_by(value: "amis"), wine: wine_3 )
WineTag.create!(tag: Tag.find_by(value: "poisson"), wine: wine_3 )
WineTag.create!(tag: Tag.find_by(value: "blanc"), wine: wine_3 )
WineTag.create!(tag: Tag.find_by(value: "léger"), wine: wine_3 )
WineTag.create!(tag: Tag.find_by(value: "sulfites"), wine: wine_3 )

WineTag.create!(tag: Tag.find_by(value: "collègues"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "poisson"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "blanc"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "léger"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "sulfites"), wine: wine_4 )

WineTag.create!(tag: Tag.find_by(value: "collègues"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "végétarien"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "rosé"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "fruité"), wine: wine_4 )
WineTag.create!(tag: Tag.find_by(value: "bio"), wine: wine_4 )
